...
service='guangzhou'
def func1():
    Aqi_Minutes(service,'%s_aqi'%service).api_start('广州')
def func2():
    Location_Minutes(service,'%s_location'%service).location_start('广州')
def func3():
    Typhoon_Minutes(service,'%s_typhoon'%service).typhoon_start('广州')
