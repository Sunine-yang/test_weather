...
from util.foreign_date import foreign_condition
from util.timestamp_deal import hourlys_time_deal
...
def foreign_big_condition_case(data):
    big_condition_t1 = ''
    big_condition_t2 = ''
    big_condition_t3 = ''
    big_condition_t4 = ''
    ...
    # 城市信息是否正确
        ...
        try:
            aaaa = data['data']['condition']
        except BaseException:
            big_condition_t1 = '无实况天气'
        else:

            # 实况天气
            if len(data['data']['condition']) == 29:
                pass
            else:
            ...
            c = foreign_condition(timestamp, timezone)
            if c < 2:
                pass
            else:
