...
datedeal = DateDeal()
code_to_name_dic = datedeal.china_dic_code_name()
citycode_dic = datedeal.china_dic_citycode()
province_dic = datedeal.china_dic_province()
timeZone_dic = datedeal.china_dic_timeZone()


def big_base_case(accucode, data):
    big_base_t1 = ''
    big_base_t2 = ''
    big_base_t3 = ''
    big_base_t4 = ''
