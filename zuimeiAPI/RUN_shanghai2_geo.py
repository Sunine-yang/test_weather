...
a = Geo(path=text_Path_shanghai())
mail = SendEG(path=text_Path_shanghai(), name='上海2')
...
# 搜索
time.sleep(2)
mail.send_email_geo(path=text_Path_shanghai())
time.sleep(5)
re_file_search_big_geo(path=text_Path_shanghai())
end_time = time.time()
